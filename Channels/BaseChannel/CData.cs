...
namespace CData
{
    public class CCancelData
    {
        public string channelOrderCode_ = "";       // 채널 주문코드
        public Int32 CancelCount_ = 0;              // 취소 개수
        public string State_ = "";                  // 상태 정보
    }

    public class COrderData
    {
        ...
        public string goodsPassType = "";           // 상품타입(타겟,프리)
        public Int32  goodsSendType_ = -1;           // 상품 발송타입(0:일반,1:핀코드,2:QR,3:Barcode)
        ...
        public string ExData_GoodsNick_ = "";       // 상품명에서 특수문자와 공백을 뺀값
        public string ExData_Option_ = "";          // 옵션명( 특수문자와 공백을 뺀값);
