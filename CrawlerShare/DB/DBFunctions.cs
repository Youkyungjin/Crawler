...
namespace CrawlerShare
{
    public class DBFunctions
    {
        ...
        public static bool GetCrawlerInfo_Authority(SqlHelper dbHelper, Int32 nChannelIdx, Int32 PartnerIdx, Int32 AuthrityIdx)
        {
            bool bResult = false;
            ...
            try
            {
                ...
                argdic.Add("xChannelIdx", nChannelIdx.ToString());
                argdic.Add("xPartnerIdx", PartnerIdx.ToString());
                argdic.Add("xAuthorityIdx", AuthrityIdx.ToString());
